...
public class FightScene extends GeneralScene{
    ...
    /**
     * Draw the opponent, the image depend on the type of the enemy.
     */
    ...
    /**
     * Draw hero stats (hp,power,status).
     */
    public void drawHeroStats(){
        //Draw Hero Stats
    ...
    /**
     * Draw the item and all item stats.
     */
    public void drawItem(){
        ...
        //Draw item stats
        Font myFontStats = Font.font("Arial", FontWeight.BOLD, 17);
        gc.setFont(myFontStats);
        gc.setFill(Color.WHITE);
        //Search all values
